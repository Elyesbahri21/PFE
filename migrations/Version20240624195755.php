 ...
 */
final class Version20240624195755 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE visite RENAME INDEX idx_xxxxxxxx TO IDX_B09C8CBB1823061F');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE visite RENAME INDEX idx_b09c8cbb1823061f TO IDX_XXXXXXXX');
    }
}
