 ...
 */
final class Version20240701200416 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE visite ADD responsable_id INT DEFAULT NULL, DROP responsable');
        $this->addSql('CREATE INDEX IDX_B09C8CBB53C59D72 ON visite (responsable_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE visite DROP FOREIGN KEY FK_B09C8CBB53C59D72');
        $this->addSql('DROP INDEX IDX_B09C8CBB53C59D72 ON visite');
        $this->addSql('ALTER TABLE visite ADD responsable INT NOT NULL, DROP responsable_id');
